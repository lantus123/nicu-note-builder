...
S['02_極早產24w_插管_PIH']=[...BASE,set('gaW','24'),set('gaD','2'),set('bw','620'),set('ap1','4'),set('ap5','6'),
  ...
  seg('pathway','direct'),seg('resus','intubation'),seg('obRespType','ett'),
...
S['03_足月MSAF_胎兒窘迫_CPR_MAS']=[...BASE,set('gaW','39'),set('gaD','1'),set('bw','3180'),set('ap1','3'),set('ap5','7'),
  ...
  seg('pathway','direct'),seg('resus','cpr'),hcm('cxrDx','mas'),hct('workup'),hc('abxPlan','course')];
S['04_晚期早產35w_TTN_嬰兒室轉入']=[...BASE,set('gaW','35'),set('gaD','0'),set('bw','2350'),
  seg('delivery','nsd'),seg('pathway','nursery'),seg('pwOnset','developed'),set('pwOnsetH','3'),msel('obSx','tachypnea'),
...
S['06_PROM18h_GBS陽性_敗血症風險']=[...BASE,set('gaW','36'),set('gaD','5'),set('bw','2680'),
  seg('delivery','nsd'),ryn('prom'),set('promH','18'),ryn('fever'),seg('iap','incomplete'),
...
S['07_外接outborn三段']=[...BASE,set('gaW','33'),set('gaD','2'),set('bw','1890'),
  seg('delivery','nsd'),seg('pathway','outborn'),seg('obRespType','o2'),hcm('cxrDx','rds1'),hct('workup')];
S['08_出生後會診']=[...BASE,set('gaW','37'),set('gaD','6'),set('bw','2890'),
  seg('delivery','nsd'),seg('pathway','consult'),msel('obSx','grunting'),seg('obRespType','o2')];
S['09_產前standby']=[...BASE,set('gaW','29'),set('gaD','0'),set('bw','1180'),
  seg('delivery','cs'),ryn('pih'),seg('pathway','standby'),am('resp','NCPAP'),hct('workup')];
...
S['13_低Apgar_DOIC_急救插管']=[...BASE,set('gaW','32'),set('gaD','6'),set('bw','1720'),set('ap1','2'),set('ap5','5'),
  seg('delivery','cs'),tog('fd'),tog('doic'),seg('pathway','direct'),seg('resus','intubation'),
  seg('obRespType','ett'),hct('workup'),hct('aline'),hct('bicarb'),hcm('cxrDx','rds2'),hcm('cxrDx','ptx')];
...
S['15_雙氧氣症狀_嬰兒室觀察後轉入']=[...BASE,set('gaW','36'),set('gaD','0'),set('bw','2450'),
  seg('delivery','nsd'),seg('pathway','nursery'),seg('pwOnset','developed'),set('pwOnsetH','6'),msel('obSx','cyanosis'),msel('obSx','desaturation'),
  seg('obRespType','o2'),hcm('cxrDx','ttn'),hcm('cxrDx','infl'),hct('workup'),hc('infMarkers','both'),hc('abxPlan','improve')];
S['16_足月順產_觀察']=[...BASE,set('gaW','40'),set('gaD','1'),set('bw','3350'),
  seg('delivery','nsd'),seg('pathway','direct')];
